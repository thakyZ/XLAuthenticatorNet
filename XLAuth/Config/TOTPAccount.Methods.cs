...
[Serializable]
internal sealed partial class TOTPAccount : IKeyProvider, IEquatable<TOTPAccount>, IEquatable<object> {
  /// <summary>
  ...
  public static DateTime GetNistTime() {
    ...
    try {
      using var response = App.HttpClient.GetAsync("https://www.google.com").Result;
