...
internal class AddAccountDialogViewModel : ViewModelBase<AddAccountDialog> {
  /// <summary>
  /// Gets the value of the title
  /// </summary>
  public string Title => Loc.Localize(nameof(AddAccountDialog) + nameof(Title), "New Account");
  /// <summary>
  ...
  /// </summary>
  public ICommand SubmitAddAccountDialog => new CommandImpl(() => {
  ...
  public ICommand CancelAddAccountDialog => new CommandImpl(() => {
