...
/// <summary>
/// JSON converter for <see cref="T:System.Guid"/>.
...
internal class IPAddressJsonConverter : JsonConverter<IPAddress> {
  ...
  /// <value><see langword="true"/> if this <see cref="T:Newtonsoft.Json.JsonConverter}"/> can write JSON; otherwise, <see langword="false"/>.</value>
  ...
  public override IPAddress? ReadJson(JsonReader reader, Type objectType, IPAddress? existingValue, bool hasExistingValue, JsonSerializer serializer) {
    return reader.Value is string str && IPAddress.TryParse(str, out IPAddress? address) ? address : null;
  }
}